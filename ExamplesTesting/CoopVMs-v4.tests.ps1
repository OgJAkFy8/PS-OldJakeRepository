...
# describes the function Get-VirtualMachines
Describe 'Get-VirtualMachines' {
  ...
  Context 'Running without arguments'   {
    ...
    It 'runs without errors' {
      ...
      # scriptblock (braces):
      { Get-VirtualMachines } | Should Not Throw
    }
    It 'does something' {
      # call function Get-VirtualMachines and pipe the result to an assertion
      # Example:
      # Get-VirtualMachines | Should Be 'Expected Output'
      # Hint: 
    ...
    It 'does not return anything'     {
      Get-VirtualMachines | Should BeNullOrEmpty 
    }
  }
}
